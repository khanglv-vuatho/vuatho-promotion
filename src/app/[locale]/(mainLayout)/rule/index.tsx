...
export const BodyRule = memo(() => {
  ...
  return (
    <div className='py-[110px] 3xl:py-[120px] bg-[url("/promotion-images/bg.webp")] bg-cover bg-no-repeat bg-center'>
        ...
        <div className='p-4 md:p-10 rounded-[20px] bg-gradient-to-b from-[#0D6DDE] to-[#A0CCFF]'>
          <div className='flex flex-col gap-5'>
            ...
            <div className='w-full'>
              <ImageFallback
                src={isInvite ? '/promotion-images/invite.webp' : '/promotion-images/invite1.webp'}
                alt=''
                width={2100}
                height={500}
      ...
      <div className='grid grid-cols-3 text-center divide-x-1 divide-[#0D6DDE] *:bg-white *:text-primary-blue *:font-bold '>
        <div className='divide-y-1 divide-[#0D6DDE] *:h-1/3 *:p-4'>
          <div className='flex items-center gap-2 !pl-14'>
            <div>
              <ImageFallback
                src='/promotion-images/rank1.png'
                alt='rank1'
                width={45}
                height={54}
          ...
          <div className='flex items-center gap-2 !pl-14'>
            <div>
              <ImageFallback
                src='/promotion-images/rank2.webp'
                alt='rank2'
                width={45}
                height={54}
                className='pointer-events-none select-none h-[55px] w-[45px] max-h-[55px] max-w-[45px] min-h-[55px] min-w-[45px]'
          ...
          <div className='rounded-bl-xl flex items-center gap-2 !pl-14'>
            <div>
              <ImageFallback
                src='/promotion-images/rank3.webp'
                alt='rank3'
                width={45}
                height={54}
                className='pointer-events-none select-none h-[55px] w-[45px] max-h-[55px] max-w-[45px] min-h-[55px] min-w-[45px]'

...
export const langs = [
  {
    ...
    code: 'en',
    active: true,
    symbol: <Image radius='none' src='https://flagcdn.com/20x15/gb.png' width='20' height='15' alt='English' />
  },
  {
    label: 'Tiếng Việt',
    code: 'vi',
    active: true,
    symbol: <Image radius='none' src='https://flagcdn.com/20x15/vn.png' width='20' height='15' alt='Tiếng Việt' />
  },
  {
    label: '简体中文',
    code: 'zh',
    active: true,
    symbol: <Image radius='none' src='https://flagcdn.com/20x15/cn.png' width='20' height='15' alt='简体中文' />
  },
  {
    label: '한국인',
    code: 'kr',
    active: true,
    symbol: <Image radius='none' src='https://flagcdn.com/20x15/kr.png' width='20' height='15' alt='한국인' />
  },
  {
    label: 'Français',
    code: 'fr',
    active: true,
    symbol: <Image radius='none' src='https://flagcdn.com/20x15/fr.png' width='20' height='15' alt='Français' />
  },
  { label: 'Français (Afrique)', code: 'fr-AF', active: true, symbol: '🌍' },
  {
    ...
    code: 'fil',
    active: true,
    symbol: <Image radius='none' src='https://flagcdn.com/20x15/ph.png' width='20' height='15' alt='Filipino' />
  },
  {
    label: 'Italiano',
    code: 'it',
    active: true,
    symbol: <Image radius='none' src='https://flagcdn.com/20x15/it.png' width='20' height='15' alt='Italiano' />
  },
  {
    label: 'Polski',
    code: 'pl',
    active: true,
    symbol: <Image radius='none' src='https://flagcdn.com/20x15/pl.png' width='20' height='15' alt='Polski' />
  },
  {
    label: 'Português (Brasil)',
    code: 'pt-BR',
    active: true,
    symbol: <Image radius='none' src='https://flagcdn.com/20x15/br.png' width='20' height='15' alt='Português (Brasil)' />
  },
  {
    label: 'Português (Portugal)',
    code: 'pt-PT',
    active: true,
    symbol: <Image radius='none' src='https://flagcdn.com/20x15/pt.png' width='20' height='15' alt='Português (Portugal)' />
  },
  {
    label: 'Română',
    code: 'ro',
    active: true,
    symbol: <Image radius='none' src='https://flagcdn.com/20x15/ro.png' width='20' height='15' alt='Română' />
  },
  {
    label: 'Svenska',
    code: 'sv',
    active: true,
    symbol: <Image radius='none' src='https://flagcdn.com/20x15/sv.png' width='20' height='15' alt='Svenska' />
  },
  {
    label: 'Slovenčina',
    code: 'sk',
    active: true,
    symbol: <Image radius='none' src='https://flagcdn.com/20x15/sk.png' width='20' height='15' alt='Slovenčina' />
  },
  {
    label: 'Slovenščina',
    code: 'sl',
    active: true,
    symbol: <Image radius='none' src='https://flagcdn.com/20x15/sl.png' width='20' height='15' alt='Slovenščina' />
  },
  {
    label: 'Türkçe',
    code: 'tr',
    active: true,
    symbol: <Image radius='none' src='https://flagcdn.com/20x15/tr.png' width='20' height='15' alt='Türkçe' />
  },
  {
    label: 'latviešu valoda',
    code: 'lv',
    active: true,
    symbol: <Image radius='none' src='https://flagcdn.com/20x15/lv.png' width='20' height='15' alt='latviešu valoda' />
  },
  {
    label: 'Čeština',
    code: 'cs',
    active: true,
    symbol: <Image radius='none' src='https://flagcdn.com/20x15/cz.png' width='20' height='15' alt='Čeština' />
  },
  {
    label: 'Ελληνικά',
    code: 'el',
    active: true,
    symbol: <Image radius='none' src='https://flagcdn.com/20x15/gr.png' width='20' height='15' alt='Ελληνικά' />
  },
  {
    label: 'Русский',
    code: 'ru',
    active: true,
    symbol: <Image radius='none' src='https://flagcdn.com/20x15/ru.png' width='20' height='15' alt='Русский' />
  },
  {
    label: 'Українська',
    code: 'uk',
    active: true,
    symbol: <Image radius='none' src='https://flagcdn.com/20x15/ua.png' width='20' height='15' alt='Українська' />
  },
  {
    label: 'български',
    code: 'bg',
    active: true,
    symbol: <Image radius='none' src='https://flagcdn.com/20x15/hu.png' width='20' height='15' alt='български' />
  },
  {
    label: 'العربية',
    code: 'ar',
    active: true,
    symbol: <Image radius='none' src='https://flagcdn.com/20x15/sa.png' width='20' height='15' alt='العربية' />
  },
  {
    label: 'اردو',
    code: 'ur',
    active: true,
    symbol: <Image radius='none' src='https://flagcdn.com/20x15/pk.png' width='20' height='15' alt='اردو' />
  },
  {
    label: 'বাংলা',
    code: 'bn',
    active: true,
    symbol: <Image radius='none' src='https://flagcdn.com/20x15/bd.png' width='20' height='15' alt='বাংলা' />
  },

  {
    ...
    code: 'zh-TW',
    active: true,
    symbol: <Image radius='none' src='https://flagcdn.com/20x15/tw.png' width='20' height='15' alt='繁體中文' />
  },
  {
    label: '日本',
    code: 'ja',
    active: true,
    symbol: <Image radius='none' src='https://flagcdn.com/20x15/jp.png' width='20' height='15' alt='日本' />
  },
  {
    label: 'ภาษาไทย',
    code: 'th',
    active: true,
    symbol: <Image radius='none' src='https://flagcdn.com/20x15/th.png' width='20' height='15' alt='ภาษาไทย' />
  },
  {
    label: 'Bahasa Indonesia',
    code: 'id',
    active: true,
    symbol: <Image radius='none' src='https://flagcdn.com/20x15/id.png' width='20' height='15' alt='Bahasa Indonesia' />
  },
  {
    label: 'Wikang Tagalog',
    code: 'tl',
    active: false,
    symbol: <Image radius='none' src='https://flagcdn.com/20x15/ph.png' width='20' height='15' alt='Wikang Tagalog' />
  },
  {
    label: 'ភាសាខ្មែរ',
    code: 'km',
    active: false,
    symbol: <Image radius='none' src='https://flagcdn.com/20x15/kh.png' width='20' height='15' alt='ភាសាខ្មែរ' />
  },
  {
    label: 'ພາສາລາວ',
    code: 'lo',
    active: false,
    symbol: <Image radius='none' src='https://flagcdn.com/20x15/la.png' width='20' height='15' alt='ພາສາລາວ' />
  },
  {
    label: 'မြန်မာစာ',
    code: 'my',
    active: false,
    symbol: <Image radius='none' src='https://flagcdn.com/20x15/mm.png' width='20' height='15' alt='မြန်မာစာ' />
  },
  {
    label: 'Bahasa Melayu',
    code: 'ms',
    active: false,
    symbol: <Image radius='none' src='https://flagcdn.com/20x15/bn.png' width='20' height='15' alt='Bahasa Melayu' />
  },
  {
    label: 'हिन्दी',
    code: 'hi',
    active: false,
    symbol: <Image radius='none' src='https://flagcdn.com/20x15/in.png' width='20' height='15' alt='हिन्दी' />
  },
  {
    label: 'Deutsch',
    code: 'de',
    active: false,
    symbol: <Image radius='none' src='https://flagcdn.com/20x15/de.png' width='20' height='15' alt='Deutsch' />
  },
  {
    label: 'Español',
    code: 'es',
    active: false,
    symbol: <Image radius='none' src='https://flagcdn.com/20x15/es.png' width='20' height='15' alt='Español' />
  }
]
